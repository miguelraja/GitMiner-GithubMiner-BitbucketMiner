...
public class UserData {
    ...
    public static UserData toUserData(User user) {
        ...
        data.setNodeId(user.getNodeId());
        data.setAvatarUrl(user.getAvatarUrl());
        data.setGravatarId(user.getGravatarId());
        data.setUrl(user.getUrl());
        data.setHtmlUrl(user.getHtmlUrl());
        data.setFollowersUrl(user.getFollowersUrl());
        data.setFollowingUrl(user.getFollowingUrl());
        data.setGistsUrl(user.getGistsUrl());
        data.setStarredUrl(user.getStarredUrl());
        data.setSubscriptionsUrl(user.getSubscriptionsUrl());
        data.setOrganizationsUrl(user.getOrganizationsUrl());
        data.setReposUrl(user.getReposUrl());
        data.setEventsUrl(user.getEventsUrl());
        data.setReceivedEventsUrl(user.getReceivedEventsUrl());
        data.setType(user.getType());
        data.setUserViewType(user.getUserViewType());
        data.setSiteAdmin(user.getSiteAdmin());
        return data;
    }
